...
function launch(prefix, containerId, config) {
    ...
    for (var i = 0; i < deps.length; i++) {
        ...
        elem.onload = function() {
            ...
            var randomPreset =  Math.floor(Math.random() * Math.floor(Object.keys(presets).length-1))
            console.log(presets[Object.keys(presets)[randomPreset]])

            config.rotationRate =  presets[Object.keys(presets)[randomPreset]].rotate
            config.shrinkLeft = presets[Object.keys(presets)[randomPreset]].shrink_left
            config.shrinkRight = presets[Object.keys(presets)[randomPreset]].shrink_right
            config.shrinkTop = presets[Object.keys(presets)[randomPreset]].shrink_top
            config.shrinkBottom = presets[Object.keys(presets)[randomPreset]].shrink_bottom
            ...
            console.log(x,y)
            // var canvas = yoob.makeCanvas(container, '500px','600px');
